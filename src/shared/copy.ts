...
export const FORTUNE = {
  ...
  prompt: {
    system:
      ...
      '반드시 JSON 만 출력하세요: {"headline": "...", "body": "...", "mission": "...", "starters": ["..."], "oneLiner": "...", "matchNote": "..."}\n' +
      "headline: 25자 이내 한 줄.\n" +
      ...
      "starters: 오늘 파티에서 옆 사람에게 바로 건넬 수 있는 첫 문장 2~3개. 각 30자 이내.\n" +
      "  대답하기 쉽고 부담 없는 것으로 — 이 사람의 매력에서 이어지면 더 좋습니다.\n" +
      "oneLiner: 오늘 하루 지니고 다닐 한 문장. 25자 이내, 다짐이 아니라 부적처럼.\n" +
  ...
  fallback: {
    ...
    /** 파티에서 바로 건넬 첫 문장들. 미션과 달리 '해야 할 일'이 아니라 '쓸 수 있는 말'이다 */
    starters: [
      "여기 어떻게 오게 되셨어요?",
      "오늘 오면서 뭐 듣고 오셨어요?",
      "이 근처 자주 오세요?",
