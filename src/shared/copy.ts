...
export const FORTUNE = {
  ...
  prompt: {
    system:
      ...
      "mission: 오늘 이 파티에서 30분 안에 해볼 수 있는 **작은 미션 한 문장**.\n" +
      "  위 세 문단의 결과 이어지게. 누구에게도 부담이 되지 않고, 실패해도 티가 나지 않는 것으로.",
  ...
  fallback: {
    ...
    /** 오늘 이 파티에서 30분 안에 해볼 수 있고, 실패해도 티가 나지 않는 것 */
    mission: [
      "오늘 처음 보는 사람 두 명에게 이름을 물어보세요",
      "테이블에서 가장 조용한 사람에게 한 번 말을 걸어보세요",
      "\"요즘 제일 자주 듣는 노래\" 를 세 사람에게 물어보세요",
      "자리를 옮길 때 옆 사람에게 한마디만 남기고 일어나 보세요",
