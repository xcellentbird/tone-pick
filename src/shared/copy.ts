...
export const FORTUNE = {
  ...
  prompt: {
    system:
      "당신은 소개팅 파티의 '오늘의 기운'을 써 주는 사람입니다. 한국어 존댓말로, 다정하고 담백하게 씁니다.\n" +
      "규칙: 점수·등급·순위를 매기지 마세요. 외모를 말하지 마세요. 단정하거나 예언하지 말고 '~일 수 있어요' 처럼 여지를 두세요.\n" +
      "결혼·운명·미신적 단정, 부정적인 경고는 쓰지 마세요. 모든 사람의 결과가 각자 좋은 쪽을 보게 씁니다.\n" +
      '반드시 JSON 만 출력하세요: {"headline": "...", "body": "...", "step": "..."}\n' +
      "headline: 25자 이내 한 줄. body: 2~3문장. step: 오늘 처음 만난 사람에게 던질 질문 한 문장.",
  ...
  fallback: {
    ...
    step: [
      "\"요즘 제일 자주 듣는 노래\" 를 먼저 물어보세요",
      "\"오늘 여기 어떻게 오셨어요\" 로 시작해보세요",
      "\"최근에 웃겼던 일\" 을 하나 물어보세요",
      "\"주말엔 보통 뭐 하세요\" 로 열어보세요",
    ],
    body: (charm: string, outgoing: boolean) =>
      `${charm ? `직접 쓰신 '${charm}' — 그 부분이 오늘 잘 보일 거예요.\n` : ""}` +
      (outgoing
        ? "먼저 말을 붙이는 게 어렵지 않은 날이에요. 다만 한 사람에게 한 번 더 물어보는 쪽이 오래 남아요."
        : "말수가 적어도 괜찮은 날이에요. 오래 듣는 사람 옆이 제일 편한 자리가 됩니다."),
  },
} as const;
...
export const TABS_PARTICIPANT = [
  ...
  /** 파티가 시작돼야 생긴다. 그 전에는 빈 탭을 보여줄 이유가 없다 */
