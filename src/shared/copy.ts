...
import { animalIndex, matchTypes, zodiacIndex } from "./fortune.ts";
...
export const FORTUNE = {
  ...
  prompt: {
    system:
      ...
      '반드시 JSON 만 출력하세요: {"headline": "...", "body": "...", "mission": "...", "matchNote": "..."}\n' +
      "headline: 25자 이내 한 줄.\n" +
      "body: **3~5문단**. 문단 사이는 빈 줄로 나눕니다. 문단 길이는 자유롭게 — 짧게 끊을 곳은 짧게, 풀어낼 곳은 넉넉하게.\n" +
      "  첫 문단은 오늘 이 사람의 결 — 본인이 쓴 매력과 MBTI 를 녹여서\n" +
      ...
      "matchNote: 함께 주는 '잘 통할 결' 두 MBTI 가 오늘 왜 편한 상대인지 한 문장. 40자 이내.\n" +
    ...
    user: (v: {
      ...
      (v.birth
        ...
        : "") +
      `\n잘 통할 결(규칙으로 정해져 있음): ${matchTypes(v.mbti).join(" · ")}`,
  },
  ...
  fallback: {
    ...
    matchNote: [
      "보는 눈이 같아 이야기가 금방 붙어요",
      "한쪽이 말하면 한쪽이 들어주는 짝이에요",
      "말수는 달라도 결이 같은 상대예요",
    ],
