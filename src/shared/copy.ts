...
export const ME = {
  title: "내 정보",
  /**
   * 등록할 때 낸 것은 **사전 투표가 열리기 전까지만** 고칠 수 있다 (ADR-31).
   ...
   */
  locked: "사전 투표가 시작돼서 이제 고칠 수 없어요.",
...
export const HOME = {
  todo: {
    ...
    /**
     * 사전 투표와 겹치지 않게 **"프로필 ↔ 직접 만난 사람"** 으로 가른다.
     * 본문에 "사전 투표" 라고 쓰지 않는다 — 단계 이름은 운영자 용어다 (이 파일 머리말).
     */
    party: {
...
export const STATUS = {
   ...
   *
   * 사전 투표 **시작**은 다르다. 예약이 걸리는 둘 중 하나라(ADR-14) 진짜 시각이 있다.
   * 그래서 등록 중에는 그쪽을 세고, 사전 투표가 열리면 파티를 센다 —
