  ...
  return (
    <>
      ...
      */}
      ...
      {/*
        잠긴 뒤에는 **아무 말도 하지 않는다.** 고칠 수 있는 동안에만 마감과 버튼이 서고,
        지나면 그 자리가 통째로 빈다 — 못 하는 일을 화면에 남겨두지 않는다.

        (같은 문구가 서버의 409 응답으로는 살아 있다 — 폼을 열어둔 채 투표가 시작돼
        저장을 누른 사람에게는 왜 튕겼는지 말해야 한다. `ME.locked` 참고.)
      */}
      {canEdit && (
        <div className="stack">
          {/*
